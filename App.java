...
public class App {
    public static void main(String[] args) {
        ...
        // // 2)
            ...
            boolean isAvailable = trainer.checkAvailability("Beerus@example.com", "2024-04-07", "10:00:00");
            System.out.println("Trainer availability: " + isAvailable);

            boolean isAvailable2 = trainer.checkAvailability("Beerus@example.com", "2024-04-07", "21:00:00");
            System.out.println("Trainer availability: " + isAvailable2);
